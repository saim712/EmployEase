    ...
    <>
      <div className="card bg-slate-400 text-center text-teal-200 p-6 h-full shrink-0 rounded-sm w-[40%] ">
          ...
          <div className='mt-3 flex gap-2 w-fit '>
            <button className="bg-emerald-500 cursor-pointer mx-3  px-2 py-2 text-amber-100 font-semibold rounded">Mark as Completed</button>
            <button className="bg-emerald-500 cursor-pointer  px-2 py-2 text-amber-100 font-semibold rounded">Mark as Failed</button>
          </div>
        </div>
    </>
  )
